...
def actualizar_persona(num_documento: str, tipo_documento: int, primer_nombre: str, segundo_nombre: str, 
        primer_apellido: str, segundo_apellido: str, telefono:int, fecha_nacimiento:date, sexo: bool):
    print("--------------ENTROOOOOO----------------------")
    response = supabase.table('Persona').update({
        "num_documento": num_documento, 
        "tipo_documento": tipo_documento, 
        "primer_nombre": primer_nombre,
        "segundo_nombre": segundo_nombre,
    ...
    print(num_documento, tipo_documento, primer_nombre, segundo_nombre, 
        primer_apellido, segundo_apellido, telefono, fecha_nacimiento, sexo)
    return response
